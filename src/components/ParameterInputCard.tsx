...
const ParameterInputCard: React.FC<ParameterInputCardProps> = ({ label, value, onChange, isMDE, mdeType, setMdeType, mdeTypeOptions }) => {
  return (
    <div className="p-4 bg-white shadow-lg rounded-lg">
      <div className="bg-gray-100 p-3 rounded-md">
        ...
        {isMDE && mdeTypeOptions && (
          <div className="mt-2">
            <span className="text-sm font-medium text-gray-700">MDE Type: </span>
