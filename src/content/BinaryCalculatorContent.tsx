...
const BinaryCalculatorContent: React.FC = () => (
  <div>
    ...
    <p>The calculator uses a two-sided Z-test to compute the sample size. A Z-score tells us how far from the mean a data point is, in terms of standard deviations. Just trying to keep my github squares green at this point. Really getting desperate at this point. Blah, blah, blah, blah, blah, blah</p>
